...
@endif
{{  Form::open( array('url' => action('Owner\HomeController@store'), 'files'=>true,'method'=>'post','enctype'=>'multipart/form-data') )  }}
  @csrf
  <div class="preview text-center">
    @if ($owner->image ?? '')
    <img class="preview-img" src="/{{$owner->image}}" alt="{{$owner->image}}" i width="200" height="200"/>
    @else
    ...
    @endif
               ...
               <div class="browse-button">
                   ...
                   <input class="browse-input" type="file"required name="image" id="UploadedFile" accept="image/*" />
